...
#if ENABLED(SDSUPPORT && DIRECT_STEPPING)
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_ALERT_BEEPS          7  // Number of alert beeps to play when a response is needed.
...
#if ANY(WIFISUPPORT, ESP3D_WIFISUPPORT)   // _hijakd_
