...
#define STRING_CONFIG_H_AUTHOR "(hijakd, CRX Monster)" // Who made the changes.  // _hijakd_
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_PRO_V1_2  // _hijakd_
#endif
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 1   // _hijakd_
...
#define CUSTOM_MACHINE_NAME "CR-X Monster"   // _hijakd_
 ...
 */
#define X_DRIVER_TYPE TMC2209   // _hijakd_
#define Y_DRIVER_TYPE TMC2209   // _hijakd_
#define Z_DRIVER_TYPE TMC2209   // _hijakd_
...
#define E0_DRIVER_TYPE TMC2209   // _hijakd_
#define E1_DRIVER_TYPE TMC2209   // _hijakd_
...
// :[0, 1, 2, 3, 4, 5, 6, 7, 8]
#define EXTRUDERS 2   // _hijakd_

// Generally expected filament diameter (1.75, 2.85, 3.0, ...). Used for Volumetric, Filament Width Sensor, etc.
#define DEFAULT_NOMINAL_FILAMENT_DIA 1.75

// For Cyclops or any "multi-extruder" that shares a single nozzle.
#define SINGLENOZZLE   // _hijakd_
...
#if ANY(PARKING_EXTRUDER, MAGNETIC_PARKING_EXTRUDER) // _hijakd_
...
#define HEATER_0_MAXTEMP 300   // _hijakd_
...
#define PID_K1   0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 19.00   // _hijakd_
    #define DEFAULT_Ki 1.40    // _hijakd_
    #define DEFAULT_Kd 66.00   // _hijakd_
  #endif
#else
...
#if ANY(DELTA_AUTO_CALIBRATION, DELTA_CALIBRATION_MENU)  // _hijakd_
...
// #define MORGAN_SCARA
// #define MP_SCARA
#if ANY(MORGAN_SCARA, MP_SCARA) // _hijakd_
...
#define ENDSTOP_INTERRUPTS_FEATURE  // _hijakd_
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 10, 75 }   // _hijakd_
...
#define USE_PROBE_FOR_Z_HOMING   // _hijakd_
 ...
 */
#define Z_MIN_PROBE_PIN PG_8 // Pin 32 is the RAMPS default   // _hijakd_
 ...
 */
#define PROBE_MANUALLY   // _hijakd_
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 10, 10, 0 }  // JHA_CHANGE_THIS?
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   15 // (mm) Z Clearance for Deploy/Stow  // _hijakd_
#define Z_CLEARANCE_BETWEEN_PROBES  5 // (mm) Z Clearance between probe points
#define Z_CLEARANCE_MULTI_PROBE     5 // (mm) Z Clearance between multiple probes
//#define Z_AFTER_PROBING           5 // (mm) Z position after probing is done

#define Z_PROBE_LOW_POINT          0 // (mm) Farthest distance below the trigger-point to go before stopping   // _hijakd_
...
// #define DISABLE_X  // _hijakd_
// #define DISABLE_Y  // _hijakd_
// #define DISABLE_Z  // _hijakd_
// #define DISABLE_I
// #define DISABLE_J
// #define DISABLE_K
// #define DISABLE_U
...
#define INVERT_Z_DIR true  // _hijakd_
...
#define INVERT_E1_DIR true   // _hijakd_
...
#define X_BED_SIZE 300   // _hijakd_
#define Y_BED_SIZE 300   // _hijakd_
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  // #define MIN_SOFTWARE_ENDSTOP_Z   // _hijakd_
...
#if ANY(MIN_SOFTWARE_ENDSTOPS, MAX_SOFTWARE_ENDSTOPS) // _hijakd_
#define SOFT_ENDSTOPS_MENU_ITEM                       // Enable/Disable software endstops from the LCD   // _hijakd_
#endif
...
#define AUTO_BED_LEVELING_BILINEAR  // _hijakd_
 ...
 */
#define RESTORE_LEVELING_AFTER_G28  // _hijakd_
...
// #define DEBUG_LEVELING_FEATURE
   ...
   */
  #define G26_MESH_VALIDATION   // _hijakd_
...
#if ANY(AUTO_BED_LEVELING_LINEAR, AUTO_BED_LEVELING_BILINEAR)  // _hijakd_
 ...
 */
#define LCD_BED_LEVELING   // _hijakd_
...
#define LCD_BED_TRAMMING   // _hijakd_
...
#define MANUAL_X_HOME_POS X_MIN_POS   // _hijakd_
#define MANUAL_Y_HOME_POS Y_MIN_POS   // _hijakd_
 ...
 */
#define EEPROM_SETTINGS     // Persistent storage with M500 and M501   // _hijakd_
...
#define PREHEAT_2_LABEL       "PETG"   // _hijakd_
#define PREHEAT_2_TEMP_HOTEND 230   // _hijakd_
#define PREHEAT_2_TEMP_BED    70   // _hijakd_
#define PREHEAT_2_TEMP_CHAMBER 35   // _hijakd_
#define PREHEAT_2_FAN_SPEED     0 // Value from 0 to 255   // _hijakd_

#define PREHEAT_3_LABEL       "ABS"   // _hijakd_
#define PREHEAT_3_TEMP_HOTEND 240   // _hijakd_
#define PREHEAT_3_TEMP_BED    110   // _hijakd_
#define PREHEAT_3_TEMP_CHAMBER 35   // _hijakd_
#define PREHEAT_3_FAN_SPEED     0 // Value from 0 to 255   // _hijakd_
 ...
 */
#define NOZZLE_PARK_FEATURE   // _hijakd_
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU    // _hijakd_
#define INDIVIDUAL_AXIS_HOMING_SUBMENU // _hijakd_
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER   // _hijakd_
...
#if ANY(ANYCUBIC_LCD_I3MEGA, ANYCUBIC_LCD_CHIRON) // _hijakd_
...
#if ANY(RGB_LED, RGBW_LED) // _hijakd_
