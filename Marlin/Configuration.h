 ...
 */
#define DEFAULT_ACCELERATION          750    // X, Y, Z and E acceleration for printing moves  // _hijakd_
#define DEFAULT_RETRACT_ACCELERATION  1000    // E acceleration for retracts  // _hijakd_
#define DEFAULT_TRAVEL_ACCELERATION   300    // X, Y, Z acceleration for travel (non printing) moves  // _hijakd_
