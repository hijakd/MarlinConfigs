 ...
 */
  ...
  #if ENABLED(ADAPTIVE_FAN_SLOWING && PIDTEMP)   // _hijakd_
...
#if ANY(INPUT_SHAPING_X, INPUT_SHAPING_Y)   // _hijakd_
...
#if ANY(DIGIPOT_MCP4018, DIGIPOT_MCP4451)   // _hijakd_
...
#if ANY(HAS_DISPLAY, DWIN_LCD_PROUI)   // _hijakd_
  // The timeout to return to the status screen from sub-menus
  //#define LCD_TIMEOUT_TO_STATUS 15000   // (ms)

  #if ENABLED(SHOW_BOOTSCREEN)
    #define BOOTSCREEN_TIMEOUT 4000       // (ms) Total Duration to display the boot screen(s)
    #if ANY(HAS_MARLINUI_U8GLIB, TFT_COLOR_UI)   // _hijakd_
...
// LCD Print Progress options. Multiple times may be displayed in turn.
#if HAS_DISPLAY && ANY(SDSUPPORT, SET_PROGRESS_MANUALLY)   // _hijakd_
  ...
  #if ANY(HAS_MARLINUI_HD44780, IS_TFTGLCD_PANEL)   // _hijakd_
 ...
 */
#if ANY(AUTO_BED_LEVELING_3POINT, AUTO_BED_LEVELING_UBL)   // _hijakd_
...
#if ANY(MESH_BED_LEVELING, AUTO_BED_LEVELING_UBL)   // _hijakd_
...
#if ENABLED(AUTO_BED_LEVELING_UBL && EEPROM_SETTINGS)   // _hijakd_
...
#if ANY(ARC_SUPPORT, BEZIER_CURVE_SUPPORT)   // _hijakd_
...
#if ENABLED(SDSUPPORT && DIRECT_STEPPING)  // _hijakd_
 ...
 */
#define ADVANCED_PAUSE_FEATURE  // _hijakd_
#if ENABLED(ADVANCED_PAUSE_FEATURE)
  #define PAUSE_PARK_RETRACT_FEEDRATE         60  // (mm/s) Initial retract feedrate.
  #define PAUSE_PARK_RETRACT_LENGTH            4  // (mm) Initial retract.  // _hijakd_
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE  40  // (mm/s) Load filament feedrate. This can be pretty fast.  // _hijakd_
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   100  // (mm) Load length of filament, from extruder gear to nozzle.  // _hijakd_
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define FILAMENT_UNLOAD_PURGE_RETRACT        4  // (mm) Unload initial retract length.  // _hijakd_
  #define FILAMENT_UNLOAD_PURGE_DELAY       5000  // (ms) Delay for the filament to cool after retract.
  #define FILAMENT_UNLOAD_PURGE_LENGTH         2  // (mm) An unretract is done, then this length is purged.  // _hijakd_
  ...
  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change.  // _hijakd_
 ...
 */
   ...
   */
  #define MONITOR_DRIVER_STATUS  // _hijakd_
  ...
  #if ANY(SENSORLESS_HOMING, SENSORLESS_PROBING)   // _hijakd_
    // TMC2209: 0...255. TMC2130: -64...63
    #define X_STALL_SENSITIVITY  125   // _hijakd_
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  125   // _hijakd_
...
#if ANY(SPINDLE_FEATURE, LASER_FEATURE)   // _hijakd_
...
#define EXTENDED_CAPABILITIES_REPORT
  ...
  #define M115_GEOMETRY_REPORT   // _hijakd_
#endif
...
#define M114_DETAIL         // Use 'M114` for details to check planner calculations   // _hijakd_
#define M114_REALTIME       // Real current position based on forward kinematics   // _hijakd_
 ...
 * @section calibrate
 */
#define MECHANICAL_GANTRY_CALIBRATION   // _hijakd_
#if ENABLED(MECHANICAL_GANTRY_CALIBRATION)
  #define GANTRY_CALIBRATION_CURRENT          400     // Default calibration current in ma   // _hijakd_
  #define GANTRY_CALIBRATION_EXTRA_HEIGHT       5     // Extra distance in mm past Z_###_POS to move   // _hijakd_
